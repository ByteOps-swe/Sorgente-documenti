...
Dopo una riflessione, si è deciso di inizialmente richiedere un colloquio per la valutazione del Proof of Concept (PoC) e dell'analisi dei requisiti. Successivamente, verrà valutato il momento più adatto per la richiesta della seconda fase di revisione.
