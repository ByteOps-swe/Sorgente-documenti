...
\begin{tabular}{|C{2.5cm}|C{2.5cm}|C{2.5cm}|C{2.5cm}|C{2.5cm}|}
    ...
    \hline \hline
    0.0.1 & 19/02/2024 & R. Smanio & F. Pozza & Redazione documento \\
    \hline
\end{tabular}
\pagebreak
...
La proponente è stata informata che il team ha ottenuto l'approvazione per avanzare con la seconda fase della revisione RTB. Inoltre, è stata condotta una breve discussione riguardo alle correzioni da apportare al documento Analisi dei Requisiti in merito ai requisiti funzionali.
