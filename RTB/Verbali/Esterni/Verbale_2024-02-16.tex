...
\section{Attività da svolgere}
    \begin{itemize}
        \item Procedere con la progettazione del database Clickhouse senza preoccuparsi della ridondanza;
        \item Redazione del manuale utente senza procedure di installazione;
        \item Esecuzione manuale di test di integrazione.
    \end{itemize}
