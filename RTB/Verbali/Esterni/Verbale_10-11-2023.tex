...
\section{Attività da svolgere}  %le \textit{attività}\textsubscript{\textit{G}} inserite servono solo a dare un'idea. non sono definitive, non sono scritte correttamente!
    \begin{center}
