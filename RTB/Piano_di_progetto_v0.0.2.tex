...
\subsection{Pianificazione e Monitoraggio dell'Avanzamento del Progetto}
...
Al termine del primo periodo, l'ammontare parziale totale del costo del progetto è \textbf{ 1115\euro\ } e sono state completate il \textbf{100\%} delle attività attese.
...
\subsubsection*{Preventivo orario per membro}


    \begin{tabular}{|C{3cm}|C{1cm}|C{1cm}|C{1cm}|C{1cm}|C{1cm}|C{1cm}|C{3cm}|}
        \hline

        \textbf{Membro}  & \textbf{Re}  & \textbf{Am} & \textbf{An} & \textbf{Pt} & \textbf{Pr} & \textbf{Ve} & \textbf{Totale per persona}\\
        \hline\hline

        A. Barutta    & 2                                                    & 5                              & 8                                & -      & 2            & 1             & 18                         \\
        \hline
