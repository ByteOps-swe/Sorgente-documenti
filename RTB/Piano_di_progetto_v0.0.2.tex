...
\usepackage{pgf-pie, titlesec, comment, tabularx, makecell, listings, array, setspace, geometry, graphicx, xcolor, xparse, fancyvrb, relsize, fancyhdr, booktabs, hyperref, eurosym}
...
alla luce di quanto analizzato nelle sezioni di:
\begin{itemize}
...
\begin{table}[ht]
    ...
    \begin{tabular}{|c|c|}
        ...
        \hline
        Requirements and Technology Baseline1 & 20/12/2023 \\
...
Lo Scrum, con le sue pratiche iterative e collaborative, offre una risposta efficace alle sfide e alle mutevoli esigenze del mondo contemporaneo dello sviluppo software. Attraverso l'implementazione di Scrum, il nostro team mira a ottenere numerosi benefici positivi che influenzeranno in modo significativo il successo del progetto.
