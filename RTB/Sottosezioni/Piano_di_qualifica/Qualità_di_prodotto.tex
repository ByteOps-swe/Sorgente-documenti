...
\hspace{1pt}
    \begin{longtable}{|C{1.5cm}|L{3cm}|L{4cm}|L{2.5cm}|L{2.5cm}|}
            ...
            \hline
            \stepcounter{metriccounter}\textbf{M\arabic{metriccounter}DE} & Densità Errori & Misura la percentuale di errori presenti nel prodotto rispetto al totale del codice. & $\leq 10\%$ & $ 0\%$ \\
            \hline
