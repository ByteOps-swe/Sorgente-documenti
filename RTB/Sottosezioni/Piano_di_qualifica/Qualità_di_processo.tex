...
\hspace{1pt}
        ...
        \hline
        \stepcounter{metriccounter}\textbf{M\arabic{metriccounter}CNC} & CoNdition Coverage & Metrica di copertura del codice che indica la percentuale di condizioni logiche nel codice sorgente che sono state eseguite durante i test. & $\geq 80\%$ & $100\%$ \\
        \hline
