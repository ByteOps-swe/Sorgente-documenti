...
\hspace{1pt}
        ...
        \hline
        \stepcounter{metriccounter}\textbf{M\arabic{metriccounter}SC} & Statement Coverage & Metrica di copertura del codice che indica la percentuale degli statement del codice coperti dai test. & $\geq 80\%$ & $100\%$ \\
        \hline
        \stepcounter{metriccounter}\textbf{M\arabic{metriccounter}BC} & Branch Coverage & Metrica di copertura del codice che indica la percentuale dei rami decisionali del codice coperti dai test. & $\geq 80\%$ & $100\%$ \\
        \hline
