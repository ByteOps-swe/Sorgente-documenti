...
Il nome del branch destinato alla redazione o modifica del documento o di una sua sezione deve essere descrittivo al fine di consentire un'identificazione immediata e precisa del documento o della sezione su cui si sta lavorando. Pertanto, relativamente alla redazione dei documenti, deve essere adottata la \textbf{convenzione per la nomenclatura dei branch} esposta nella sezione 3.4. \todo{inserisci la sezione corretta}
