...
\vspace{0.1cm}
\textbf{Caso redazione nuovo documento/sezione o modifica documento/sezione preesistente}\\ \todo{redazione nuovo documento o sezione oppure modifica documento o sezione già validata}
...
\textbf{Caso modifica documento in stato di redazione} \\\todo{questi sono tutti paragrafi zio cane}
...
\hypertarget{}{\textbf{Salvataggio e condivisione progressi di task non completate}} \\
...
\begin{enumerate}
    ...
    \item Attuano una \textbf{pull request:}
          \begin{enumerate}
              ...
              \item Eseguire i passaggi dettagliati nel caso "\textit{\textbf{Salvataggio e condivisione progressi di task non completate}}";\todo{link}
              ...
              \item Dai un titolo e una breve descrizione\todo{è da specificare come e cosa scrivere come titolo e come descrizione?} alla pull request >> Seleziona i verificatori su "Reviewers" >> Clicca "Create pull request".
          \end{enumerate}
\end{enumerate}
