...
\begin{table}[H]
  ...
  \hline \hline
  M2EAC & Estimated at Completion (\textit{EAC}\textsubscript{\textit{G}}) &  \hyperlink{item:M2EAC}{\textcolor{linkcolor}{M2EAC}} \\
  M3CPI & Cost Performance Index (\textit{CPI}\textsubscript{\textit{G}}) &  \hyperlink{item:M3CPI}{\textcolor{linkcolor}{M3CPI}} \\
  M4BV & Budeget Variance (BV) &  \hyperlink{item:M4BV}{\textcolor{linkcolor}{M4BV}} \\
  M5AC & Actual Cost (AC) &  \hyperlink{item:M5AC}{\textcolor{linkcolor}{M5AC}} \\
  M6SV & Schedule Variance (SV) &  \hyperlink{item:M6SV}{\textcolor{linkcolor}{M6SV}} \\
  M7EV & Earned Value (EV) &  \hyperlink{item:M7EV}{\textcolor{linkcolor}{M7EV}} \\
  M8PV & Planned Value (\textit{PV}\textsubscript{\textit{G}}) &  \hyperlink{item:M8PV}{\textcolor{linkcolor}{M8PV}} \\
  M9ETC & Estimate to Complete (\textit{ETC}\textsubscript{\textit{G}}) &  \hyperlink{item:M9ETC}{\textcolor{linkcolor}{M9ETC}} \\
