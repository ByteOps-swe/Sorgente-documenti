...
\begin{table}[H]
  ...
  \hline \hline
  M2EAC & Estimated at Completion (EAC) &  \hyperlink{item:M2EAC}{\textcolor{linkcolor}{M2EAC}} \\
  M3CPI & Cost Performance Index (CPI) &  \hyperlink{item:M3CPI}{\textcolor{linkcolor}{M3CPI}} \\
  ...
  M8PV & Planned Value (PV) &  \hyperlink{item:M8PV}{\textcolor{linkcolor}{M8PV}} \\
  M9ETC & Estimate to Complete (ETC) &  \hyperlink{item:M9ETC}{\textcolor{linkcolor}{M9ETC}} \\
