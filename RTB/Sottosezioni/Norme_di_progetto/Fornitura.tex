...
\textit{Piano di Progetto}\todo{link, ma non c'è la release}, il quale delineerà le attività, le risorse e i costi indispensabili per la realizzazione del prodotto.
...
L'\textit{Analisi dei Requisiti}\todo{manca link release corretta} è un documento che contiene la descrizione in dettaglio dei requisiti, dei casi d'uso e definisce in modo esaustivo le funzionalità che il prodotto offirà.\\
...
Il \textit{Piano di Progetto}\todo{manca link release corretta} è un documento stilato ed aggiornato continuamente che tratta i seguenti temi:
\begin{itemize}
...
Il \textit{Piano di Qualifica}\todo{manca link release corretta} è un documento essenziale che illustra le strategie di verifica e validazione per garantire che il prodotto soddisfi le aspettative del committente e della proponente. Esso identifica le metodologie di verifica, i criteri di validazione e le risorse coinvolte, assicurando un processo di controllo qualità efficiente.
Il documento contiene le seguenti sezioni:
\begin{itemize}
...
\begin{itemize}
    ...
    \item  \textbf{Excel:} Servizio cloud utilizzato per la creazione dei grafici di preventivo e consuntivo di periodo presenti nel documento \textit{Piano di Progetto}\todo{manca link release corretta}.
\end{itemize}
