...
\begin{itemize}
    ...
    \item \textbf{Metrica M2EAC:}
          \begin{itemize}
              ...
              \item \textbf{Formula:} $\textit{EAC}\textsubscript{\textit{G}} = AC + \textit{ETC}\textsubscript{\textit{G}}$
          \end{itemize}
    ...
    \item \textbf{Metrica M4BV:}
          \begin{itemize}
              ...
              \item \textbf{Formula:} $BV = AC - \textit{PV}\textsubscript{\textit{G}} \times 100\% $
          \end{itemize}
    ...
    \item \textbf{Metrica M6SV:}
          \begin{itemize}
              ...
              \\con \begin{itemize}
                \item $FP$: giorno pianificato di fine \textit{attività}\textsubscript{\textit{G}};
                \item $IP$: giorno pianificato di inizio \textit{attività}\textsubscript{\textit{G}};
                \item $FC$: giorno consuntivato di fine \textit{attività}\textsubscript{\textit{G}};
                \item $IC$: giorno consuntivato di inizio \textit{attività}\textsubscript{\textit{G}}.
            \end{itemize}
