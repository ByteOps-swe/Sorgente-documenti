...
\begin{itemize}
    \item Tecnologie utilizzate: Specifica le tecnologie e le librerie di terze parti integrate nel sistema;
    \item Architettura logica: Definisce i componenti, i ruoli, le connessioni e le interazioni nel sistema;
    \item Architettura di deployment: Indica come le componenti architetturali vengono allocate e distribuite nel sistema in esecuzione;
    \item Pattern architetturali e design pattern: Descrive i design pattern architetturali adottati e quelli influenzati dalle tecnologie utilizzate, oltre agli eventuali idiomi a livello più basso;
    \item Vincoli e linee guida: Include restrizioni e regole da seguire durante lo sviluppo;
    \item Procedure di testing e validazione: Indica i processi per testare e verificare che il software soddisfi i requisiti specificati;
    \item Requisiti tecnici: Specifica in dettaglio i requisiti prestazionali, di sicurezza, di scalabilità e di compatibilità con determinate piattaforme che il software deve soddisfare
\end{itemize}
...
A supporto dell'attività di progettazione verranno utlizzati i seguenti diagrammi:
\begin{itemize}
...
\begin{enumerate}
    \item \textbf{Nome della classe}: Identificativo della classe. È rappresentato in grassetto seguendo la convenzione PascalCase e deve esplicitare chiaramente la responsabilità della classe. Se la classe è astratta, il nome viene scritto in corsivo.
...
I diagrammi delle classi sono collegati tra loro mediante frecce che delineano le rispettive relazioni di dipendenza. Qui di seguito, saranno delineate le rappresentazioni mediante frecce per le diverse relazioni: \\
\begin{itemize}
    \item Dipendenza: Rappresentata con una freccia tratteggiata
    \begin{figure}[h]
        \centering
    ...
    \end{figure}
    \item Associazione: Rappresentata tramite una linea continua e orientata fra due classi. Molteplicità: quanti oggetti possono far parte dell'associazione.
    \begin{figure}[h]
        \centering
    ...
    \end{figure}
    \item Aggregazione: Rappresentata con una freccia a diamante vuota
    \begin{figure}[h]
        \centering
    ...
    \end{figure}
    \item Composizione: Rappresentata con una freccia a diamante piena
    \begin{figure}[h]
        \centering
    ...
    \end{figure}
    \item Generalizzazione: Rappresentata con una freccia continua vuota
    \begin{figure}[h]
        \centering
    ...
    \end{figure}
    \item Interface Realization: Un'interfaccia A può essere implementata utilizzando una classe B, sia concreta che astratta, e è rappresentato graficamente tramite una freccia da B a A
    \begin{figure}[h]
        \centering
