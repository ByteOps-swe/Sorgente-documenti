...
\begin{itemize}
    \item \textbf{Dipendenza}: Rappresentata con una freccia tratteggiata
    \begin{figure}[h]
        \centering
    ...
    \end{figure}
    \item \textbf{Associazione}: Rappresentata tramite una linea continua e orientata fra due classi. Molteplicità: quanti oggetti possono far parte dell'associazione.
    \begin{figure}[h]
        \centering
    ...
    \end{figure}
    \item \textbf{Composizione}: Rappresentata con una freccia a diamante piena
    \begin{figure}[h]
        \centering
    ...
    \end{figure}
    \item \textbf{Generalizzazione}: Rappresentata con una freccia continua vuota
    \begin{figure}[h]
        \centering
    ...
    \end{figure}
    \item \textbf{Interface Realization}: Un'interfaccia A può essere implementata utilizzando una classe B, sia concreta che astratta, e è rappresentato graficamente tramite una freccia da B a A
    \begin{figure}[h]
        \centering
