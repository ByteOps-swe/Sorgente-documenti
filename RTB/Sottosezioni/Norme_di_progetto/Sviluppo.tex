...
È fondamentale definire l'architettura del prodotto prima di avviare la fase di codifica perseguendo correttezza per costruzione piuttosto che correttezza per correzione e in modo tale da gestire efficientemente la complessità del prodotto, garantendo una struttura solida e coerente durante tutto il processo di sviluppo.
