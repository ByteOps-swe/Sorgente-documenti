...
Nel caso in cui un membro del team identifichi un problema, è obbligatorio notificarlo immediatamente al gruppo, e contemporaneamente, deve essere aperta una segnalazione nel sistema di tracciamento delle issue (ITS) con l'etichetta "bug" e una descrizione completa del problema. La procedura per l'apertura di una issue è descritta nel dettaglio nella sezione \hyperlink{par:ticketing}{\textit{Ticketing}}. \todo{non so se è corretto, nella sez. Ticketing viene spiegato "come creare una issue per assegnare nuovi task", non per segnalare problemi}
