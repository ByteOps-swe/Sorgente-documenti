...
\begin{itemize}
    ...
    Ciò include le versioni attuali, le revisioni, le modifiche e le baselines;
          \begin{itemize}
              ...
              \item  \textbf{Branching \& DashBoard:} Per visionare la presenza di lavori in corso su di un Configuration Item si utilizza a supporto la presenza di branch attivi che lo riguardano e il posizionamento di issue associate nella Dashboard di progetto. \todo{da riformulare}
                    \begin{itemize}
                        \item Ogni issue è associato ad un CI tramite label.  \label{sec:ticketing} \todo{inserire riferimento corretto, dovrebbe essere a pagina 68}
                    \end{itemize}
          \end{itemize}
