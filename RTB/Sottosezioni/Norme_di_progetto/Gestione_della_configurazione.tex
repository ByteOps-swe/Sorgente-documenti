...
\begin{enumerate}
    ...
    \item \textbf{Branch \texttt{feature}:} Creati da \texttt{develop}, sono utilizzati per lo sviluppo di nuove funzionalità o miglioramenti. Una volta completato, il branch \texttt{feature} viene unito a \texttt{develop};
