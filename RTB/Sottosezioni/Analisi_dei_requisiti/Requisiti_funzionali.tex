...
\begin{longtable}{|C{1cm}|C{2cm}|>{\raggedright}m{5cm}|C{2cm}|C{1.5cm}|}
    ...
    \hline
    \stepcounter{rowcounter} RF\arabic{rowcounter} & Obbligatorio & La visualizzazione delle misurazioni in formato testuale deve presentare le informazioni nel formato: \textit{TIMESTAMP, Dato}. & Capitolato & UC4 \\
