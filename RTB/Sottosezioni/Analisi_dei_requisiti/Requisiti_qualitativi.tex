...
\begin{longtable}{|C{1.5cm}|C{2cm}|L{5cm}|C{2cm}|}
    ...
    %RQ1
    \hline
    \stepcounter{rowcounter} RQ\arabic{rowcounter} & Obbligatorio & Devono essere rispettate tutte le norme definite in Norme di Progetto sezione 2.2.2. & Decisione interna, Norme di Progetto\\

    %RQ2
    \hline
    \stepcounter{rowcounter} RQ\arabic{rowcounter} & Obbligatorio & Devono essere rispettati i vincoli e le metriche definiti in Piano di Qualifica sezione 2.3.1.1. & Decisione interna, Piano di Qualifica \\
