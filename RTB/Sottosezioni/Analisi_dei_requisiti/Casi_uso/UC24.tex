...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:}
          \begin{enumerate}
              \item Il sensore effettua una rilevazione della umidità;
    ...
    \item \textbf{User story associata:}
          \begin{itemize}
            \item Come Sensore, voglio trasmettere in modo affidabile i dati di umidità al sistema, in modo che possano essere memorizzati e elaborati 
          \end{itemize}
\end{itemize}
