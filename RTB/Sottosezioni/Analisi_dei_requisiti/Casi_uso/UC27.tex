...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:}
          \begin{enumerate}
              \item Il sensore effettua una rilevazione sullo stato della colonnina di ricarica (Occupata, Libera);
    ...
    \item \textbf{User story associata:}
          \begin{itemize}
            \item Come Sensore, voglio trasmettere in modo affidabile i dati sullo stato della stato della colonnina di ricarica al sistema, in modo che possano essere memorizzati e elaborati 
          \end{itemize}
\end{itemize}
