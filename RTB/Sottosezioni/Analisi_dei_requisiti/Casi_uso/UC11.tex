...
\begin{itemize}
    ...
    \item \textbf{Postcondizioni:}
        \begin{itemize}
            \item L'autorità locale visualizza un widget contenente le misurazioni relative ai sensori di occupazione delle colonnine di ricarica in formato mappa interattiva.
        \end{itemize}
