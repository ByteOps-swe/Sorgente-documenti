...
\begin{itemize}
    \item \textbf{RT-1A-1} - \textcolor{red}{Inesperienza nell'attività di progettazione} (\textit{(\ref{sec:rischioTec})})
    \begin{itemize}
    ...
    \end{itemize}
    \item \textcolor{red}{Inesperienza nell'attività di testing}
\end{itemize}
