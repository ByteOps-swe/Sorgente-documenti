...
\begin{itemize}
    \item \textbf{RO-2A-4} - \textcolor{red}{Inesperienza nell'attività di progettazione} (\textit{\ref{sec:inexpAttività}})
    \item \textbf{RO-2A-4} - \textcolor{red}{Inesperienza nell'attività di testing} (\textit{\ref{sec:inexpAttività}})
\end{itemize}
