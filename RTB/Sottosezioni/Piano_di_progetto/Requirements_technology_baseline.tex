...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Esito mitigazione:} 
        Il responsabile ha saggiamente limitato il numero di attività da avviare in questo periodo, garantendo così il completo svolgimento di tutte le attività pianificate.
        \item \textbf{Impatto:}
...
\paragraph{Preventivo e consuntivo orario per membro} \hspace{1pt}
Per le attività registrate nei costi, sono stati assegnati i seguenti ruoli, alcuni membri hanno svolto più ruoli una volta concluse le loro attività. 
