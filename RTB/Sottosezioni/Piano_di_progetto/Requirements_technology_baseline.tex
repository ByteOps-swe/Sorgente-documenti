...
Per le attività registrate nei costi, sono stati assegnati i seguenti ruoli: \hspace{1pt}
...
\begin{table}[h]
    ...
    \label{tab:ruoli_persone_seconda}
    \end{table}
...
Al termine del terzo periodo, l'ammontare parziale totale del costo del progetto è \textbf{ 2238\euro\ } e sono state completate il \textbf{100\%} delle attività attese.
    ...
    \begin{minipage}[b]{0.45\textwidth}
        ...
        \begin{tikzpicture}
            \pie[
                ...
                radius=2, 
                line width=0pt
            ]{18/Speso, 82/Rimanente}
        \end{tikzpicture}
        \caption{Grafico a torta del budget speso e rimanente preventivato nel terzo periodo}
        \label{fig:GraficoTorta2}
    \end{minipage}
