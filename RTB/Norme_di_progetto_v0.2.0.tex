...
\vspace{0.2cm}\textbf{La corretta gestione del registro delle modifiche,le informazioni in prima pagina, il posizionamento nella repository, il branching e le DashBoard di progetto permettono l'identificazione dello stato dei CI.} \\
L'inclusione di un CI nel branch principale (main) lo configura come la versione più recente, revisionata, mentre le versioni (X.0.0) con X>=1 identificano il CI facente parte della baseline con uguale versione.% -----------------------------Processi organizzativi --------------------------------
