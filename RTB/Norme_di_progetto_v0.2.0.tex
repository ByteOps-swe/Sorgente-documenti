...
\begin{tabular}{|C{1.5cm}|C{2cm}|C{2cm}|C{2cm}|C{5cm}|}
    ...
    \label{Git_Action_Version} 0.3.0
                      & 21/11/2023      & \makecell{A. Barutta}      & E. Hysa & Sezione Gestione della configurazione \\
    \hline
    0.2.0
                      & 06/11/2023      & \makecell{A. Barutta\\N. Preto}      & R. Smanio & Sezione Comunicazione, Gestione incontri                                              \\
    \hline
    0.1.0
                      & 05/11/2023      & \makecell{A. Barutta\\N. Preto}      & R. Smanio & Sezione Documentazione,Introduzione                                                  \\
    \hline
\end{tabular}
...
Questo documento assume l'importante ruolo di costituire un registro ufficiale, atto a riportare in maniera accurata gli argomenti trattati, le decisioni adottate, le azioni da intraprendere e le figure coinvolte durante i meeting.\\
In particolare, è possibile distinguere tra verbali interni, relativi a meeting in cui sono presenti solo i componenti dell'organizzazione, e verbali esterni, che trovano applicazione quando vi sono terze parti coinvolte nelle discussioni o nelle decisioni documentate.\\
