...
\begin{itemize}
    ...
    \item  Casi d'uso: Tutte le possibili interazioni che gli attori possono compiere utilizzando il prodotto
          \begin{itemize}
              \item Attori: Utenti del prodotto; \todo{tutto ciò che è esterno al sistema, che non può essere modificato}
...
\begin{enumerate}
    ...
    \item \textbf{Scenario principale:}Sequenza di eventi che si verifica quando un attore interagisce con il sistema per raggiungere l'obbiettivo del caso d'uso (Postcondizioni); \todo{ciò che avviene tra le precondizioni e postcondizioni}
...
\todo{tutti i campi dati dei casi d'uso sono da raffinare}
...
\begin{itemize}
    ...
    \item Architettura del prodotto software.
\end{itemize}
al fine di ottenere un prodotto adeguato alle necessità degli stakeholder. \\ \todo{da raffinare! vedi dispense T6}
