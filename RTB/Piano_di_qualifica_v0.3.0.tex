...
\begin{tabular}{|C{1.5cm}|C{2cm}|C{2cm}|C{2cm}|C{5cm}|}
    ...
    \hline \hline
<<<<<<< HEAD:RTB/Piano_di_qualifica_v0.2.0.tex
    \label{Git_Action_Version} 0.2.2
=======
    \label{Git_Action_Version} 0.3.0
    & 05/01/2023      & \makecell{D. Diotto}      & A. Barutta & \makecell{Aggiunti test di sistema \\ e test di accettazione} \\
    \hline
    0.2.0
>>>>>>> main:RTB/Piano_di_qualifica_v0.3.0.tex
    & 27/12/2023      & \makecell{D. Diotto}      & A. Barutta & \makecell{Refactoring Sezione 2 } \\
    \hline
    0.1.0
