...
glossario = ["actual cost", "analisi dei requisiti","Analisi dei Rquisiti","apache kafka","Apache Kafka","API","api","architettura","arg","artefatto","attività","best practice","big data","bit","branch","broker","budget at completion","budget variance","customer acceptance","calendario","change management","Clickhouse","ClickHouse","clickhouse","committente","complessità ciclomatica per metodo","MCCM","configuration item","configuration management","container","cost performance index","CPI","dashboard","database","database nosql","data gathering","data streaming processing","data visualization","deep dive","demo","devops","disaccoppiare","Discord","dispositivi iot","Docker","docker","Dockerfile","dockerfile","earned value","element","estimated at completion","EAC","estimated to complete","ETC","Faker","faker","Feature branch","feature branch","fornitore","framework","Framework","front-end","gmail","Github","github","github actions","google meet","Grafana","ID","IEEE","integrazione","issue","issue tracking system","jira","json","Kafka","kafka","latex","Latex","label","librerie","log","maschera","milestone","multi-stage builds","MVP","normalizzazione","olap","olistico","open-source","Overleaf","overleaf","paradigma","pattern","pdf","piattaforma","PB","planned value","PV","POC","poc","PoC","processi","programma","proponente","Python","python","Pull request","pull request","raw","report","repository","requisiti contrattuali","requisiti soluzione","requisiti utente","rete","roadmap","rollback","routine di codice","RTB","schedule variance","scouting tecnologico","script","sensore","servizio","single responsability principle","SRP","sistema","Smart City","smart city","Software","software","SOLID","sql","stack tecnologico","stakeholder","standard","stand-up meeting","statement coverage","MSC","stato avanzamento lavori","SAL","storage","stream","stream processing","technology baseline","telegram","test","test di accettazione","test di integrazione","test di regressione","test di sistema","test di unità","tool","use case","UML","uml","unità architetturale","vscode","way of working","widget","workflow"]
