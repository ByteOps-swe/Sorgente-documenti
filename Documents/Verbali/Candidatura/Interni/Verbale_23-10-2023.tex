...
\begin{itemize}
    \item \textbf{\fontsize{12}{6}\selectfont Revisione dei documenti} 

    Sono stati revisionati in gruppo i documenti prodotti e sono stati validati.
    \vspace{0.5cm}

    \item \textbf{\fontsize{12}{6}\selectfont Valutazione e preventivo costi} 
    ...
    \item \textbf{\fontsize{12}{6}\selectfont Consegna prevista}
