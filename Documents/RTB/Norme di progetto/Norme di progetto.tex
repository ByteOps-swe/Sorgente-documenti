...
\vspace{0.3cm}
   ...
   Nel processo di assegnazione dei task all'interno del sistema di tracciamento degli issue (ITS), l'amministratore attribuirà i redattori come esecutori del compito. Simultaneamente, nella sezione di descrizione, verranno inseriti i nomi dei verificatori incaricati della revisione del lavoro.
