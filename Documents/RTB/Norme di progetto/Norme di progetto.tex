...
\vspace{0.3cm}
   ...
   I compiti e le procedure dei verificatori sono dettagliate al paragrafo ~\ref{sec:verificatori}. 
    ...
    Nel processo di redazione dei documenti, il compito del responsabile consiste nel: 
        ...
        \item \textbf{Approvazione:}Una volta che l'intero documento è stato completato e verificato, il responsabile si riserva il diritto di approvare il lavoro o richiedere eventuali ulteriori modifiche.
    \end{itemize}
    ...
    \begin{itemize}
        \item \textbf{Verbali interni:}Verbale interno DDMMAAA\_versioneX\_Y.tex
        \item \textbf{Verbali interni:}Verbale esterno DDMMAAA\_versioneX\_Y.tex
        \item \textbf{Norme di Progetto:} Norme di progetto\_versioneX\_Y.tex
...
\end{itemize}
\paragraph*{Indice}
Tutti i documenti generici (a eccezione di verbali e lettere) devono essere provvisti di indice.
...
Il verbale, a causa della brevità dei contenuti, sarà sprovvisto di un indice. Oltre alle informazioni presenti in prima pagina, includerà una sintetica esposizione di quanto discusso durante la riunione e un elenco puntato, suddiviso per argomenti, che dettaglia in modo più approfondito ciascun tema trattato.
