...
\paragraph{Tempo}
Il totale delle ore impiegate \todo{da inserire "nella PB" ?} dai membri del team, suddivise per ruolo, coincide con quanto preventivato inizialmente ed è il seguente:
...
\paragraph{Budget} \todo{da specificare "nella PB"?}
Il totale dei costi sostenuti dai membri del gruppo, suddivisi per ruolo, è il seguente:
\begin{figure}[H]
    \centering
