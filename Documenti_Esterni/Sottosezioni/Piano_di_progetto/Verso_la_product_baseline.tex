...
\todo{spiegare il discorso dei macroperiodi/fasi}

\paragraph{Prima fase}

\textbf{Intervallo temporale previsto}: 16/01/2024-13/02/2024 \\ 
...
\textbf{Intervallo temporale previsto}: 13/02/2024-12/03/2024 \\
...
\textbf{Intervallo temporale previsto}: 12/03/2024-25/03/2024 \\ 
...
Inoltre, in questa fase, verranno preparate le presentazioni destinate alla revisione PB. La prima presentazione, rivolta al professor Cardin, sarà incentrata sull'aspetto architetturale del prodotto, mentre la seconda, destinata al professor Vardanega, si concentrerà maggiormente sugli aspetti metodologici. \todo{eventualmente inserire conclusione}

\vspace{0.4cm}

\textbf{Rischi preventivati} \todo{ventualmente inserire altri rischi}
\begin{itemize}
