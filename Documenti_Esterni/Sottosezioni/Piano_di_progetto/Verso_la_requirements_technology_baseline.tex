...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Impatto:}
            ...
            Inoltre, al fine di conformarsi alle best practices dell'ambiente, è stata presa la decisione di regolamentare, nel documento \textit{Norme di Progetto - \S~2.5}, la configurazione dell'ambiente \textit{Docker}\textsubscript{\textit{G}}.
    \end{itemize}
\end{itemize}
...
L'amministratore ha redatto il Glossario di progetto e definito gli \textit{standard}\textsubscript{\textit{G}} e le metriche di qualità di processo e prodotti nel documento \textit{Piano di qualifica - \S~2.1}.
...
L'amministratore si è concentrato sulla redazione della sezione "Obiettivi metrici e di qualità" (\S~2) in \textit{Piano di qualifica}, nonché sulla definizione e revisione delle metriche di qualità. 
