...
\begin{itemize}
    ...
    \item \textbf{Postcondizioni:}
        \begin{itemize}
            \item L'autorità locale visualizza la data di installazione del \textit{sensore}\textsubscript{\textit{G}}.
        \end{itemize}
    ...
    \item \textbf{User story associata:} \\
        Come autorità locale, desidero visualizzare la data di installazione di uno specifico \textit{sensore}\textsubscript{\textit{G}}.
\end{itemize}