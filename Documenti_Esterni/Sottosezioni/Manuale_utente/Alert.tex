...
\begin{itemize}
    ...
    \item \textbf{Alert pending}: \todo{Riformulare meglio}
    quando una condizione di attivazione dell'avviso è stata soddisfatta, ma il tempo di valutazione dell'avviso non è ancora trascorso.
    \begin{figure}[H]
        \centering
