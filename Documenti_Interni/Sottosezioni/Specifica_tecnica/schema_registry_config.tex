...
Per registrare uno schema nel registro degli schemi di Kafka viene utilizzato il comando \textit{curl} insieme alla \textit{Rest} API fornita dallo schema registry.

Il comando \textit{curl} viene utilizzato tramite un'immagine Docker dedicata.