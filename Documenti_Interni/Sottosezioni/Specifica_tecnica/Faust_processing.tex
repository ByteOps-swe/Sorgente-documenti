...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Metodi: }
        \begin{itemize}
            \item \textbf{adapter\_misurazione(misurazione\_salute: misurazione): None [public]} - ;
            \item \textbf{to\_json(): string [public]} - .
        \end{itemize}
        \item\textbf{Note:}
        \begin{itemize}
            \item 
...
\begin{itemize}
    ...
    \item\textbf{Attributi:}
        \begin{itemize}
        \item \textbf{health\_calculator: health\_processor\_buffer} - Un implementazione di health\_processor\_buffer.
    \end{itemize}
    \item \textbf{Metodi: }
    \begin{itemize}
