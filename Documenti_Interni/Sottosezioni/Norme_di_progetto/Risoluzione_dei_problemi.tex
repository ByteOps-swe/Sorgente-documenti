...
\paragraph{Metriche} \todo{sistema metriche}
\begin{table}[H]
    \centering
...
Nel caso in cui un membro del team identifichi un problema, è obbligatorio notificarlo immediatamente al gruppo, e contemporaneamente, deve essere aperta una segnalazione nel \textit{sistema}\textsubscript{\textit{G}} di tracciamento delle \textit{issue}\textsubscript{\textit{G}} (ITS) con l'etichetta "bug" e una descrizione completa del problema. La procedura per l'apertura di una \textit{issue}\textsubscript{\textit{G}} è descritta nel dettaglio nella sezione Ticketing (\hyperlink{par:ticketing}{\S~4.1.2.10}).
