...
Gli incontri \textit{SAL}\textsubscript{\textit{G}} (\textit{Stato Avanzamento Lavori}) con la \textit{proponente}\textsubscript{\textit{G}} sono fissati inizialmente a cadenza bisettimanale e successivamente a cadenza settimanale\todo{va bene?}, in modo da poter discutere con essa lo stato di avanzamento e le difficoltà riscontrate per quanto concerne gli obiettivi proposti nel periodo che intercorre tra un \textit{SAL}\textsubscript{\textit{G}} e il successivo, nonchè le \textit{attività}\textsubscript{\textit{G}} future da svolgere.
...
\paragraph{Specifica tecnica}\todo{completa}

\paragraph{Manuale utente}\todo{completa}
