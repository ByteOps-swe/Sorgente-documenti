...
Dal momento dell’ultimo incontro, le attività programmate sono state completate con successo. In particolare, è stato implementato un sistema di notifiche Grafana-Discord, progettato per informare l’utente in modo tempestivo su eventuali problemi o anomalie rilevate nel sistema.
In aggiunta, è stato introdotto un meccanismo di Time-To-Live (TTL) per i dati archiviati in Clickhouse. Questo meccanismo permette una gestione efficace di grandi volumi di dati e consente una pulizia automatica di dati obsoleti o non più pertinenti. Infine, è stata adottata la pratica della Continuous Integration. Questo approccio garantisce un processo di sviluppo efficiente, affidabile e di alta qualità.
...
\subsection{Proposta della proponente}
