...
\section{Ordine del giorno}
    ...
    \subsection{Revisione collettiva dei documenti redatti in \LaTeX}
        I documenti redatti dai verificatori in \textit{Latex}\textsubscript{\textit{G}} sono stati esaminati congiuntamente e successivamente caricati nella \textit{repository}\textsubscript{\textit{G}} di gruppo. 
    
    \subsection{Consegna prevista}
        È stata formalizzata la \textit{milestone}\textsubscript{\textit{G}} concernente l'assegnazione degli appalti, comprensiva delle relative responsabilità fino alla data stabilita. In seguito, saranno caricati nella \textit{repository}\textsubscript{\textit{G}} i documenti ufficialmente convalidati. 
